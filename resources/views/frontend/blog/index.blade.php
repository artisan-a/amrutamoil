...
<section class="bg-gradient-to-br from-stone-50 to-amber-50 py-12 border-b border-stone-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg text-stone-500 max-w-2xl mx-auto">
            Expert articles on cold pressed oil, healthy cooking, and traditional Indian food wisdom.
        </p>
    </div>
</section>
...
<section class="py-16 bg-stone-900 text-white text-center">
    <div class="max-w-3xl mx-auto px-4">
        ...
        <p class="text-stone-300 mb-8">Order Amrutam Cold Pressed Groundnut Oil — chemical-free, traditionally wood
            pressed.</p>
