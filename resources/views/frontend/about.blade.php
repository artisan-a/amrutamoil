...
@section('content')
<div class="bg-[#fafaf9] py-16 lg:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        <!-- Refined Premium Header -->
        <div class="relative py-12 lg:py-16 mb-12 text-center fade-in-up">
            ...
            <div class="relative z-10 max-w-3xl mx-auto px-4">
                <h1
                    class="text-4xl md:text-6xl lg:text-7xl font-extrabold text-stone-900 leading-tight mb-8 font-serif tracking-tight">
                ...
                <p class="text-lg text-stone-600 font-medium max-w-xl mx-auto leading-relaxed">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative flex justify-center fade-in-left">
                <div
                    class="relative w-full max-w-md h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl border-4 border-white transition-transform duration-500 hover:scale-[1.02]">
                ...
                <!-- Decorative emblem -->
                <div
                    class="absolute -bottom-6 -right-6 lg:-right-10 bg-white p-4 rounded-full shadow-xl w-32 h-32 flex items-center justify-center border-4 border-amber-50">
                    <div class="text-center">
                        <span class="block text-2xl font-bold text-amber-600">100%</span>
                        <span
                            class="block text-xs font-semibold text-[#78716c] uppercase tracking-widest">Natural</span>
                    </div>
                </div>
            </div>
            ...
            <div class="fade-in-right">
                <h3 class="text-3xl font-serif font-bold text-[#1c1917] mb-6">Roots in Tradition. Crafted for Health.
                </h3>

                <div class="space-y-6 text-lg text-[#57534e] leading-relaxed">
                    <p>
                ...
                <div class="mt-10 pt-10 border-t border-amber-900/50">
