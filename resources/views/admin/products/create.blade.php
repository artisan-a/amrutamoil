            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="stock_quantity" name="stock_quantity" type="number" min="0" value="0"
                            class="mt-1 block w-full border-stone-200 rounded-xl focus:border-amber-500 focus:ring-amber-500"
                            required />
                    </div>
                </div>
                ...
                <div>
                    <x-input-label for="image" value="Product Image (Optional)" class="text-stone-700 font-bold" />
                ...
                <div class="flex items-center mt-4">
                    <input id="status" type="checkbox" name="status" checked
                        class="w-5 h-5 text-amber-600 bg-stone-100 border-stone-300 rounded focus:ring-amber-500 focus:ring-2">
